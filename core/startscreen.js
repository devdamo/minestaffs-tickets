...
exports.headerDataPlugins = async (plugins) => {
    ...
    console.log("\n"+chalk.bold(chalk.underline("READY:")))
    console.log(chalk.green("✅ Bot is online and ready to handle tickets!"))
    console.log(chalk.blue("🎫 Enhanced with logging and role giver systems"))
